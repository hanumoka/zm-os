...
- 진행 문서 갱신 누락 점검:
  - `zm-claude-docs/session/current-phase.md`
  - `zm-claude-docs/session/quick-ref.md`
  - `zm-claude-docs/archive/YYYY-MM.md`
  - `zm-claude-docs/project/prd.md` (feature 작업 시)
  - `zm-claude-docs/project/roadmap.md` (Phase 진행률 변경 시)
