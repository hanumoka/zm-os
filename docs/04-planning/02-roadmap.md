...
POC 종료 후: **v2 plan v0.2.1** (2026-05-26, ⚠️ 로컬-우선 전환으로 v0.3.0 재작성 대기) → [`03-v2-plan.md`](03-v2-plan.md). 9 Epic + 53 작업 + 21주 추정. **현재 상태**: SRV-00 모노레포 마이그레이션 ✅ 완료 (2026-05-26), ADR-0013/0014/0015 ⚠️ reshape 대기. **다음**: ADR-0017 (Ports & Adapters) 작성.
